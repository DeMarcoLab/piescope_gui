...
class Ui_MainGui(object):
    def setupUi(self, MainGui):
        ...
        MainGui.resize(2362, 973)
        MainGui.setMinimumSize(QtCore.QSize(2362, 973))
        ...
        self.frame_volume.setMinimumSize(QtCore.QSize(307, 833))
        ...
        self.gridLayout_6.addItem(spacerItem7, 0, 0, 1, 2)
        self.verticalLayout.addWidget(self.frame)
        self.gridLayout_5.addWidget(self.frame_volume, 0, 0, 1, 1)
        self.frame_fluorescence = QtWidgets.QFrame(self.centralwidget)
        ...
        self.frame_fluorescence.setMinimumSize(QtCore.QSize(980, 914))
        ...
        self.button_get_basler = QtWidgets.QPushButton(self.frame_fluorescence)
        self.button_get_basler.setObjectName("button_get_basler")
        self.gridLayout_4.addWidget(self.button_get_basler, 4, 0, 1, 2)
        self.label_2 = QtWidgets.QLabel(self.frame_fluorescence)
        self.label_2.setObjectName("label_2")
        self.gridLayout_4.addWidget(self.label_2, 0, 1, 1, 1)
        self.button_live_basler = QtWidgets.QPushButton(self.frame_fluorescence)
        self.button_live_basler.setObjectName("button_live_basler")
        self.gridLayout_4.addWidget(self.button_live_basler, 5, 0, 1, 2)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(668, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_4.addWidget(self.frame_slider, 3, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.lineEdit_save_destination, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.button_save_destination, 1, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_save_destination, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.checkBox_save_destination, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEdit_save_filename, 3, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_save_filename, 2, 1, 1, 1)
        self.gridLayout_4.addWidget(self.frame_save_destination, 1, 0, 1, 2)
        self.label_fm_image = QtWidgets.QLabel(self.frame_fluorescence)
        ...
        self.label_fm_image.setMinimumSize(QtCore.QSize(960, 600))
        self.label_fm_image.setText("")
        self.label_fm_image.setObjectName("label_fm_image")
        self.gridLayout_4.addWidget(self.label_fm_image, 2, 0, 1, 2)
        self.gridLayout_5.addWidget(self.frame_fluorescence, 0, 2, 1, 1)
        ...
        self.frame_slider_2 = QtWidgets.QFrame(self.frame_2)
        ...
        spacerItem11 = QtWidgets.QSpacerItem(668, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_12.addLayout(self.layout_image_vertical_2, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.frame_slider_2, 3, 0, 1, 2)
        self.frame_save_destination_2 = QtWidgets.QFrame(self.frame_2)
        ...
        self.lineEdit_save_destination_2.setMaximumSize(QtCore.QSize(480, 20))
        self.lineEdit_save_destination_2.setObjectName("lineEdit_save_destination_2")
        self.gridLayout_7.addWidget(self.lineEdit_save_destination_2, 1, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.button_save_destination_2, 1, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.label_save_destination_2, 0, 1, 1, 1)
        spacerItem13 = QtWidgets.QSpacerItem(154, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_7.addWidget(self.checkBox_save_destination_2, 0, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.lineEdit_save_filename_2, 3, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.label_save_filename_2, 2, 1, 1, 1)
        ...
        self.label_fm_image_2 = QtWidgets.QLabel(self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_fm_image_2.setMinimumSize(QtCore.QSize(960, 600))
        self.label_fm_image_2.setText("")
        self.label_fm_image_2.setObjectName("label_fm_image_2")
        self.gridLayout.addWidget(self.label_fm_image_2, 2, 0, 1, 2)
        self.button_get_basler_2 = QtWidgets.QPushButton(self.frame_2)
        self.button_get_basler_2.setObjectName("button_get_basler_2")
        self.gridLayout.addWidget(self.button_get_basler_2, 5, 0, 1, 1)
        self.button_live_basler_2 = QtWidgets.QPushButton(self.frame_2)
        self.button_live_basler_2.setObjectName("button_live_basler_2")
        self.gridLayout.addWidget(self.button_live_basler_2, 6, 0, 1, 1)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 2362, 21))
